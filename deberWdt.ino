/*UNIVERSIDDAD TECNICA DEL NORTE
   ...
   Hay que tener en cuenta que el sistema puede ser re configurado la veces necesarias(interrupciones) Suba su enlace de su cuenta github
*/
#include <avr/wdt.h>
#include <EEPROM.h>
#include <TimerOne.h>
...
void setup() {
  ...
  Serial.println("Presione la segunda Interrupcion para activar");
  Timer1.stop();
  cont = 0;
  in=0;
  tiempo=" ";
