 ...
 * Valide la cédula ecuatoriana que se ingresa por comunicación serial con el Formato. 100337804-7  
 *Al final del procesodebe indicar si el dato es correcto o falso. Además confirmar que el total de caracteres ingresados son 11
 *   */
#include<stdlib.h>
